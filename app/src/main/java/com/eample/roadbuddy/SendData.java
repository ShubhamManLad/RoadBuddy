    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ActivityResultLauncher<String> cameraPermission = registerForActivityResult(new ActivityResultContracts.RequestPermission(), new ActivityResultCallback<Boolean>() {
            ...
            public void onActivityResult(Boolean result) {
                if (!result){
                    Toast.makeText(SendData.this, "Grant Camera Permission", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        img.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (ContextCompat.checkSelfPermission(getApplicationContext(), android.Manifest.permission.CAMERA) == PackageManager.PERMISSION_DENIED){
                    ...
                    startActivityForResult(takePic,CAMERA_REQUEST1);
                }
        ...
        img2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (ContextCompat.checkSelfPermission(getApplicationContext(), android.Manifest.permission.CAMERA) == PackageManager.PERMISSION_DENIED){
                    ...
                    Intent takePic = new Intent(MediaStore.ACTION_IMAGE_CAPTURE);
                    startActivityForResult(takePic,CAMERA_REQUEST2);
                }
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (ActivityCompat.checkSelfPermission
                    ...
                    ActivityCompat.requestPermissions(SendData.this,
                ...
                storageReferencecar.putBytes(car).addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                        Toast.makeText(SendData.this, "Car Saved", Toast.LENGTH_SHORT).show();
...
//                        finish();
                ...
                storageReferencecar = firebaseStorage.getReference("sign/"+photoID+".jpg");

                storageReferencecar.putBytes(sign).addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
                    @Override
                    public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                        Toast.makeText(SendData.this, "Sign Saved", Toast.LENGTH_SHORT).show();
                        Intent intent = new Intent(getApplicationContext(), MainActivity.class);
                        startActivity(intent);
                        finish();
                    }
            ...
            fusedLocationProviderClient.getLastLocation().addOnCompleteListener(new OnCompleteListener<Location>() {
                ...
                public void onComplete(@NonNull Task<Location> task) {
                    ...
                    if (location != null){
                        ...
                        databaseReference.child(photoID).child("latitude").setValue(String.valueOf(location.getLatitude()));
                        databaseReference.child(photoID).child("longitude").setValue(String.valueOf(location.getLongitude()));
